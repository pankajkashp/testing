...
const RightCardContent = () => {
  return (
   <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-between p-10  ">
        <h2 className="text-2xl font-bold mt-4 bg-white rounded-full items-center flex justify-center h-12 w-12 text-gray-400">1</h2>
        <div>
